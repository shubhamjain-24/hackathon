      ...
      <img src={img2} alt="" srcset="" className='s2-mainImage' />
        ...
        {/* <div className="s2_gridContainer"> */}
            ...
            <div className="s2_gridDiv2">
                ...
                Consult a Expert <br /> anytime, anywhere <br /> by <span className='s2_textHighlight'><u>one Click</u>  </span>
                </div>
                <div className="s2_gridDiv2_text2">
                Describe your feelings to a professional to receive the best treatment for your situation.
                </div>
                <div className="s2_gridDiv2_buttonDiv">
                  <div className="s2_gridDiv2_button1">
                    Ask a Consultant Online
                  </div>
                  <div className="s2_gridDiv2_button2">
                    Unlimited Chat
                  </div>
                </div>
            </div>
